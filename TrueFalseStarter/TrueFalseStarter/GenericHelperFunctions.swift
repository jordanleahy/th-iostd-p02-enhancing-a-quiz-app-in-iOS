...
// Source: http://stackoverflow.com/a/27203691/6275291 (Added parameter for alpha value to original code)
func hexStringToUIColor (hex:String, alpha: Double = 1.0) -> UIColor {
